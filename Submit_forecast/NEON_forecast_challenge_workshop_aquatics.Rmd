...
If you do not wish to run the code yourself you can follow along via the html (NEON_forecast_challenge_workshop.md), which can be downloaded from the [Github repository](https://github.com/eco4cast/NEON-forecast-challenge-workshop).
...
Information on the NEON sites can be found in the `NEON_Field_Site_Metadata_20220412.csv` file in the `eco4cast` repository on GitHub. It can be filtered to only include aquatic sites.
