...
for(i in 1:length(lake_sites$field_site_id)) {  
  ...
  # use linear regression to forecast water temperature for each ensemble member
  forecasted_temperature <- fit$coefficients[1] + fit$coefficients[2] * noaa_future_site$air_temperature + fit$coefficients[3] * noaa_future_site$air_pressure + fit$coefficients[4] * noaa_future_site$air_temperature*noaa_future_site$air_pressure
