...
If you do not wish to run the code yourself you can follow along via the html (GLEON_forecast_challenge.html), which can be downloaded from the [Github repository](https://github.com/OlssonF/GLEON-forecast-challenge). 
...
noaa_date <- forecast_date - days(4)
...
neon4cast::forecast_output_validator(forecast_file_3)
...
You can view past submissions [here:](https://shiny.ecoforecast.org/). You can also the raw scores from the bucket directly. Have a look at the get_scores.R file.
